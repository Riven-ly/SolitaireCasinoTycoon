...
public partial class SROptions
{
    ...
    //[Category("Cash"), DisplayName("Cash + $10")]
    //public void CashAdd()
    //{
    //    BE_Manager.Instance.Add_Save_Cash(1000);
    //}

    //[Category("Cash"), DisplayName("Cash - $10")]
    //public void CashReduce()
    //{
    //    BE_Manager.Instance.Add_Save_Cash(-1000);
    //}

    //[Category("Gold"), DisplayName("Gold + 500000")]
    //public void GoldAdd()
    //{
    //    BE_Manager.Instance.Add_Save_Gold(500000);
    //}

    //[Category("AmazonCard"), DisplayName("AmazonCard + 50")]
    //public void AmazonAdd()
    //{
    //    BE_Manager.Instance.Add_Save_Amazon(50);
    //}

    //[Category("Walmart"), DisplayName("Walmart + 50")]
    //public void WalmartAdd()
    //{
    //    BE_Manager.Instance.Add_Save_Walmart(50);
    //}

    ////[Category("BingoTicket"), DisplayName("BingoTicket + 10")]
    ////public void AddBintoTicket()
    ////{
    ////    BE_SaveManager.bingoData.UpdateLeftCardCount(10);
    ////}

    //[Category("ScratchTicket"), DisplayName("ScratchTicket + 10")]
    //public void AddScratchTicket()
    //{
    //    BE_Manager.Instance.Add_Save_ScratchTicket(10);
    //}

    //[Category("DiceTicket"), DisplayName("DiceTicket + 100")]
    //public void AddDiceTicket()
    //{
    //    BE_Manager.Instance.Add_Save_DiceLife(100);
    //}

    //[Category("SlotsTicket"), DisplayName("SlotsTicket + 10")]
    //public void AddSlotsTicket()
    //{
    //    BE_Manager.Instance.Add_Save_SlotsTicket(10);
    //}

    //[Category("气球"), DisplayName("气球 + 1")]
    //public void AddFlyball()
    //{
    //    BE_SaveManager.BingoFlyBall += 1;
    //}

    ////[Category("LuckyCardTicket"), DisplayName("LuckyCardTicket + 10")]
    ////public void AddLuckyCardTicket()
    ////{
    ////    BE_Manager.Instance.Add_Save_LuckyCardPuzzle(1000);
    ////}

    //[Category("AD"), DisplayName("广告次数 + 10")]
    //public void AddTodayAdTimes()
    //{
    //    BE_SaveManager.AdTimesToday += 10;
    //}

    //[Category("Bingo"), DisplayName("bingo球必中")]
    //public void OnlyBingoBall()
    //{
    //    BE_Manager.OnlyCardNum = true;
    //}

    //[Category("AD"), DisplayName("广告开")]
    //public void OpenAd()
    //{
    //    BE_Manager.isShowAd = true;
    //}

    //[Category("AD"), DisplayName("广告关")]
    //public void CloseAd()
    //{
    //    BE_Manager.isShowAd = false;
    //    // BA_SaveManagerAni.saveData.physicalData.FillGiveaways();
    //}

    //[Category("实物"), DisplayName("最大值")]
    //public void FillGiveaways()
    //{
    //     BA_SaveManagerAni.saveData.physicalData.FillGiveaways();
    //}

    //[Category("任务"), DisplayName("BingoSlotsTimes + 10")]
    //public void AddBingoSlotsTimes()
    //{
    //    for (int i = 1; i <= 14; i++)
    //    {
    //        int taskIndex = PlayerPrefs.GetInt(BE_Manager.Save_CurrentTaskIndexKey + i, 0);
    //        if (taskIndex > 0) //开始提现任务
    //        {
    //            int bingoSlots = PlayerPrefs.GetInt(BE_Manager.Save_CurrentBingoSlotsTimes + i, 0);
    //            bingoSlots += 10;
    //            PlayerPrefs.SetInt(BE_Manager.Save_CurrentBingoSlotsTimes + i, bingoSlots);
    //        }
    //    }
